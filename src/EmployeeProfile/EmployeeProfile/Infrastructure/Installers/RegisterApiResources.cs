...
using EmployeeProfile.Infrastructure.Configs;
using EmployeeProfile.Infrastructure.Handlers;
...
namespace EmployeeProfile.Infrastructure.Installers
{
    internal class RegisterApiResources : IServiceRegistration
    {
        public void RegisterAppServices(IServiceCollection services, IConfiguration config)
        {
            ...
            {
                client.BaseAddress = new Uri(config["ApiResource:ApiServer"]);
            ...
            services.AddSingleton<IDiscoveryCache>(r =>
            {
                ...
                return new DiscoveryCache(config["Sts:ServerUrl"], () => factory.CreateClient());
            });
        }
    }
}
